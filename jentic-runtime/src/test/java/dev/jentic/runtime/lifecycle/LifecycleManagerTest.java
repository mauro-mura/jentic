...
class LifecycleManagerTest {
    ...
    void shouldTrackAgentStatusDuringStartup() throws InterruptedException {
        ...
        CountDownLatch statusChanges = new CountDownLatch(2); // STARTING + RUNNING
        
        lifecycleManager.addLifecycleListener((agentId, oldStatus, newStatus) -> {
            statusChanges.countDown();
        });
        ...
        // Then
        // Should immediately be in STARTING state
        ...
        assertThat(statusChanges.await(5, TimeUnit.SECONDS)).isTrue();
    }
